export default function navbar() {
  ...
  <div id="top-banner">
    <div id="left"></div>
    <div id="center">
      <div id="faballey-img" style="cursor: pointer;" onclick="openfun()">
        <img 
    ...
    <div id="right">
      <a href="../../fabAlleyProfile/UserProfile/myorder/myorder.html" >Track Order | </a>
    <a href="" >Store Locator | </a>
    <a href="../../fabAlleyProfile/UserProfile/myorder/myorder.html" >Your Profile | </a>
    <a href="../../LOGIN/LOGIN.html" id="login-signup">Login/Signup | </a>
    <a href="" id="hi-name">  Hi,<span id="custname"> User </span></a>
    <a id="navbar-cart">
      <a href="../../Carts/components/carts.html" id="navbar-cart">
        <svg
...
<div id="navbar-mid">
  <img
    class="logo-fab "onclick="openfun()" style="cursor: pointer;"
  ...
  <div id="navbar-mid-mid">
    ...
    <div class="dropdown">
      <a href="../../ProductPage/ProductPage.html" class="dropbtn">TOPS</a>
      <div class="dropdown-content flexxxxx">
        <div class="tops-main">
        <div class="tops-left">
    ...
    <div class="dropdown">
      <a href="../../ProductPage/dress.html" class="dropbtn">DRESSES</a>
      <div class="dropdown-content flexxxxx">
        <div class="tops-main">
